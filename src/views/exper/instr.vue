    ...
    <div class="instr-box" ref="domRef">
        ...
        <template v-if="r == 1">
            ...
            <div>
                ...
                <p><strong>所需时间:</strong>本实验需要大约10分钟。</p>
                <p><strong>风险:</strong>参加本次实验没有任何可预见的风险，但您可能会由于实验任务而感到疲劳或者无聊。</p>
                <p><strong>收益:</strong>您在本实验中的主要收益是您对于科学研究的贡献！同时，为了补偿您参加研究所花费的时间和精力，我们将给予您一定的经济补偿 (¥10)，该经济补偿将通过网络进行发放。为保证本研究的数据质量，我们会在实验结束后对您的数据进行检查，如果存在不认真的情况，您的数据将被视为无效，您的报酬为0元。希望您能够理解本研究的设定，认真对待实验。当然，如果您认为本研究的这个设定不符合您的偏好，您有权选择不参加本次实验。</p>
